...
namespace ArsaProject.WebUI.Controllers
{
    public class BookingAdminController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await client.GetAsync("http://localhost:65043/api/Booking");
        ...
        public async Task<IActionResult> ApprovedReservation(ResultBookingDto resultBookingDto)
        {
            ...
            var responseMessage = await client.PutAsync("http://localhost:65043/api/Booking/bbbb", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
